...
public static Connection con() throws ClassNotFoundException, SQLException{
 Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            con = con();
            PreparedStatement pst = con.prepareStatement(String.format("SELECT * FROM Tabel_mhs WHERE Nama = '%s' ",tdb));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            con = con();
            PreparedStatement pst = con.prepareStatement(String.format("UPDATE Tabel_mhs SET  Jurusan = '%s', Email = '%s', Password = '%s', Jenis_Kelamin = '%s', Tanggal_Lahir = '%s', Alamat = '%s' WHERE Nama = '%s' ",  jurusan, email, password, jenis_kelamin, tanggal_lahir, alamat,tdb));
            ResultSet rst = pst.executeQuery();
        } catch (ClassNotFoundException ex) {
        } catch (SQLException ex) {
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            con = con();
            PreparedStatement pst = con.prepareStatement(String.format("DELETE FROM Tabel_mhs WHERE Nama = '%s' ",tdb));
            ResultSet rst = pst.executeQuery();
        } catch (ClassNotFoundException ex) {
        } catch (SQLException ex) {
        }
